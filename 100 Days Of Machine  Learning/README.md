...
🎯 Focus Areas:
  ...
  ├─ 🔄 LLMs & RAG Systems — In Progress
  └─ 📋 Agentic AI — Up Next, InshaAllah

🚀 Active Projects:
  ├─ 🧬 KP-DengueAI — Dengue Severity Classification Research
  ├─ 🚨 Street Conflict Detection — Computer Vision Client Project
  ├─ 💼 Fiverr App Deployment — Streamlit, DeepFace, Gemini API
  └─ 📊 Excelerate Data Visualization Traineeship

🌱 Community Impact:
  ├─ 🌿 Committee Member — PM Green Youth Movement (PMGYM)
  ├─ 🤝 Volunteer — Qalb Welfare Foundation, Bannu
  └─ 📢 Promoting AI education across Bannu
```
